        ...
        fetch(`https://as11server.vercel.app/creass/${_id}`,{
            ...
            .then(data => {
                ...
                if(data.modifiedCount>0){
                    Swal.fire({
                        title:'Success!',
                        text:'Assignment successfully updated added successfully',
                        icon:'success',
                    ...
                    <div className=" card w-full shadow-2xl bg-base-100 ">
                        <form onSubmit={handleSubmit} className=" grid grid-cols-2 gap-3 p-5">
                            <div className="form-control ">
                                ...
                                <input defaultValue={Title}  type="text" name="Title" placeholder="Title" className="input input-bordered" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                            ...
                            <div className="form-control">
                                ...
                                <input defaultValue={Description}  type="text" name="Description" placeholder="Description" className="input input-bordered" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Marks</span>
                                </label>
                                <input defaultValue={Marks}  type="text" name="Marks" placeholder="Marks" className="input input-bordered" required />
                            </div>
                            ...
                            <div className="form-control">
                                ...
                                <select defaultValue={Dificultiy}  name="Dificultiy" className="input input-bordered" required>
                            ...
                            <div className="form-control col-span-2">
                                <input type="submit" value="Update Assignment" className="btn bg-blue-500 w-full text-white" />
                            </div>
                        </form>
